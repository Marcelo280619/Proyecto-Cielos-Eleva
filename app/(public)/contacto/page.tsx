...
export default function ContactoPage() {
  ...
  const inputClass =
    "w-full bg-[#1a2d5a]/80 border border-white/15 rounded-lg px-5 py-4 text-white placeholder-slate-500 focus:outline-none focus:border-[#d4a574]/70 focus:bg-[#1a2d5a] transition-all text-base";

  const labelClass =
    "block text-xs font-bold uppercase tracking-widest text-[#d4a574] mb-3";
  ...
  return (
    <main className="min-h-screen bg-[#0f1e3d]">
      ...
      {/* HERO */}
      <section
        className="w-full bg-gradient-to-b from-[#0a1628] to-[#0f1e3d] border-b border-white/5"
        style={{ paddingTop: '120px', paddingBottom: '40px' }}
      >
        <div
          style={{ maxWidth: '896px', margin: '0 auto', padding: '0 32px' }}
          className="flex flex-col items-center text-center"
        >
          <div className="inline-flex items-center gap-2 bg-[#d4a574]/15 border border-[#d4a574]/30 rounded-full px-5 py-2 mb-6">
            <span className="text-[#d4a574] text-xs font-bold uppercase tracking-widest">
          ...
          <p className="text-slate-400 text-lg leading-relaxed" style={{ maxWidth: '576px' }}>
            Cuéntanos qué necesitas (medidas, ubicación, fotos si aplica) y te
            respondemos por correo o teléfono.
          </p>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  Contáctanos directamente o completa el formulario.
                </p>
              </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={item.text} className="flex items-center gap-4">
                    ...
                    {item.href ? (
                      <a href={item.href} className="text-slate-300 hover:text-[#d4a574] transition-colors font-medium text-sm">
                        {item.text}
                      </a>
                    ) : (
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
                <p className="text-xs font-bold uppercase tracking-widest text-[#d4a574] mb-4">
                  Horario de atención
                </p>
                <p className="text-slate-400 text-sm">Lunes a Viernes</p>
                <p className="text-white font-bold text-sm mb-3">08:00 – 18:00 hrs</p>
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-8 md:p-12">
                ...
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">Te respondemos en menos de 24 horas</p>
                  </div>
                </div>

                {ok ? (
                  <div className="text-center py-16">
                    <div className="w-24 h-24 bg-[#d4a574]/10 border-2 border-[#d4a574]/40 rounded-full flex items-center justify-center mb-6" style={{ margin: '0 auto 24px' }}>
                      <svg className="w-12 h-12 text-[#d4a574]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div className="w-16 h-1 bg-[#d4a574] rounded-full mb-6" style={{ margin: '0 auto 24px' }} />
                    <h3 className="text-2xl font-black text-white mb-4">¡Mensaje enviado!</h3>
                  ...
                  <form onSubmit={onSubmit} className="space-y-8">
                    ...
                    <button
                      disabled={loading}
                      className="w-full bg-[#d4a574] hover:bg-[#c89563] disabled:opacity-50 text-white font-black py-5 rounded-2xl transition-all text-lg tracking-wide hover:shadow-[0_20px_40px_-10px_rgba(212,165,116,0.4)] hover:-translate-y-0.5"
                    >
