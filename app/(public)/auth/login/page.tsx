...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-12">
      <h1 className="text-3xl font-extrabold text-[var(--eleva-blue)]">Iniciar sesión</h1>
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-4 rounded-2xl bg-white p-6 shadow-sm">
        ...
        <input name="password" type="password" required placeholder="Contraseña" className="w-full rounded-lg border px-3 py-2" />
        <button
          disabled={loading}
        ...
        <p className="text-sm text-slate-600">
          ¿No tienes cuenta?{" "}
          <Link className="font-semibold text-[var(--eleva-blue)] hover:underline" href="/auth/registro">
            Regístrate
          </Link>
        </p>
      </form>
