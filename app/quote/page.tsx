    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
      <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ paddingTop: '100px', paddingBottom: '80px' }}>
        ...
        <div className="text-center mb-20" style={{ maxWidth: '768px', width: '100%' }}>
          <p className="text-[#d4a574] uppercase tracking-[0.35em] text-xs font-bold mb-6">
            ELEVA Construcciones
          </p>
          <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-[1.05]">
            ¿Qué tipo de
            <br />
            <span className="text-[#d4a574]">cotización</span> necesitas?
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6" style={{ maxWidth: '1024px', width: '100%' }}>
          ...
          <button
            ...
            className="group relative bg-white/[0.04] border border-white/10 rounded-3xl text-left hover:bg-white/[0.08] hover:border-[#d4a574]/40 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_30px_60px_-10px_rgba(251,191,36,0.15)] flex flex-col"
            style={{ padding: '40px' }}
          >
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#d4a574]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

            <div className="flex items-center justify-between mb-10">
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#d4a574]/80 bg-[#d4a574]/10 border border-[#d4a574]/20 px-3 py-1.5 rounded-full">
                Opción 1
              </span>
              <div className="w-12 h-12 bg-[#d4a574]/10 border border-[#d4a574]/20 rounded-2xl flex items-center justify-center group-hover:bg-[#d4a574]/20 group-hover:border-[#d4a574]/40 transition-all duration-300">
            ...
            <ul className="space-y-4 mb-12 flex-1">
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-slate-300 text-sm">
                  <div className="w-5 h-5 rounded-full bg-[#d4a574]/15 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-white/10">
              <span className="text-[#d4a574] font-semibold text-sm">Comenzar cotización</span>
              <div className="w-9 h-9 rounded-xl bg-[#d4a574]/10 group-hover:bg-[#d4a574] flex items-center justify-center transition-all duration-300">
                <svg className="w-4 h-4 text-[#d4a574] group-hover:text-slate-900 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-slate-600 text-sm mt-14">
          ¿Tienes dudas?{" "}
          <a href="/contacto" className="text-slate-400 hover:text-[#d4a574] transition-colors underline underline-offset-4">
